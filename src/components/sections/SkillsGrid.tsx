    ...
    <section className="space-y-8 mt-16 pb-8">
      ...
      <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 gap-6" staggerDelay={0.12}>
        {skillCategories.map((category, i) => (
          <StaggerItem key={i}>
            <div className="flex flex-col gap-5 p-6 bg-[#121212] border border-border/40 rounded-[28px] hover:border-sky-500/30 transition-all group shadow-sm hover:shadow-sky-500/5 h-full">
